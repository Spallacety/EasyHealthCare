...
public class NovaConsulta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        especialidade = (EditText)findViewById(R.id.especialidade_nova_consulta);
        local = (EditText)findViewById(R.id.local_nova_consulta);
        data = (EditText)findViewById(R.id.data_nova_consulta);
        horario = (EditText)findViewById(R.id.horario_nova_consulta);
    }

    @Override
    public void onBackPressed() {
        Intent voltar = new Intent(NovaConsulta.this, Consultas.class);
    ...
    public void datePicker(View v){
        ...
        DatePickerDialog dlg = new DatePickerDialog(NovaConsulta.this, odsl, c.get(Calendar.YEAR), c.get(Calendar.MONTH), c.get(Calendar.DAY_OF_MONTH));
        if (dataFormat != "0/0/0") {
    ...
    public void timePicker(View v){
        ...
        final Calendar c = Calendar.getInstance();
        TimePickerDialog dlg = new TimePickerDialog(NovaConsulta.this, otsl, c.get(Calendar.HOUR_OF_DAY), c.get(Calendar.MINUTE), true);
        if (horaFormat != "0:0") {
    ...
    public void salvarConsulta(View v) {
        EditText especialidade = (EditText)findViewById(R.id.especialidade_nova_consulta);
        EditText local = (EditText)findViewById(R.id.local_nova_consulta);
        EditText data = (EditText)findViewById(R.id.data_nova_consulta);
        EditText horario = (EditText)findViewById(R.id.horario_nova_consulta);
        ...
        if ((c.getData().matches("")) || (c.getEspecialidade().matches("")) || (c.getHorário().matches("")) || (c.getLocal().matches(""))) {
            Toast.makeText(NovaConsulta.this, R.string.preencha_dados, Toast.LENGTH_SHORT).show();
        } else {
            ConsultaDAO consultaDAO = new ConsultaDAO(this);
            consultaDAO.inserir(c);
            Toast.makeText(NovaConsulta.this, R.string.dados_salvos_consulta, Toast.LENGTH_LONG).show();
            Intent voltar = new Intent(NovaConsulta.this, Consultas.class);
            startActivity(voltar);
            finish();
        }
